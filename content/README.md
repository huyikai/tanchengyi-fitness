...
当前阶段：索引与 T1 计划、T5 饮食结构已有草稿；下一步回看 T3 技术长视频。

| 类目 | 路径 | 状态 |
|------|------|------|
| 训练计划 | [plans/](./plans/) | 三分化、通用计划入口（draft） |
| 动作技术 | [technique/](./technique/) | 占位，尚未合成 |
...
| 合集 | 约集数 | 对应整理方向 |
|------|--------|----------------|
| 焚决之跟练系列（亦作「焚诀」） | 18 | 部位跟练长视频；胸/背已有动作名单线索 |
| 私教跟练系列 | 7 | 背/胸/肩/臂/腿/腹 |
| 健身房器械和动作详解 | 6 | 技术：侧平举、推胸推肩、高位下拉、划船反飞鸟、一体机等 |
...
| 焚决跟练 | 按部位长视频跟练 | 抖音合集；背/胸动作名单见 raw |
